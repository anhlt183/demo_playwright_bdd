...
class LoginPage:
    ...
    def is_login_successful(self):
        ...
        try:
            ...
            self.base_page.attach_screenshot("Login Failed")
            return False
    ...
    def is_home_page_logo_visible(self):
        try:
            ...
            self.base_page.attach_screenshot("Home Logo Failed")
            return False
    ...
    def is_error_message_correct(self, error_message):
        self.logger.info("Verify the error message is displayed correctly")
        try:
            actual_message = self.get_error_message()
            self.logger.info(f"Actual: {actual_message}, Expected: {error_message}")
            if actual_message != error_message:
                self.base_page.attach_screenshot("Error message is incorrect")
                return False
            return True 
        except Exception as e:
            self.logger.error(f"Error message is incorrect: {e}")
            self.base_page.attach_screenshot("Error message is incorrect")
            return False
    ...
    def is_logout_successful(self):
        try:
            ...
            self.base_page.attach_screenshot("Logout Failed")
            return False